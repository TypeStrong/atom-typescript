var os_1 = require("os");
var CreateBackingProperty = (function () {
    function CreateBackingProperty() {
        this.key = CreateBackingProperty.name;
    }
    CreateBackingProperty.prototype.canProvideFix = function (info) {
    ...
    CreateBackingProperty.prototype.provideFix = function (info) {
        ...
        var backingDeclaration = createBackingDeclaration(classDecl, symbolName, typeName, indentSetting, info.filePath);
    ...
    return CreateBackingProperty;
})();
exports.CreateBackingProperty = CreateBackingProperty;
function createBackingDeclaration(classDecl, symbolName, typeName, indentSetting, filePath) {
    var indent = createIndent(indentSetting, 1);
