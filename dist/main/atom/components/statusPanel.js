...
class StatusPanel {
    ...
    render() {
        ...
        if (this.props.version) {
            version = (etch.dom("div", { ref: "version", className: "inline-block" }, this.props.version));
        }
        let pendingContainer = null;
        if (this.props.pending && this.props.pending.length) {
            pendingContainer = (etch.dom("a", { ref: "pendingContainer", className: "inline-block", href: "", on: {
                    click: evt => {
                        evt.preventDefault();
        ...
        if (this.props.tsConfigPath) {
            configPathContainer = (etch.dom("a", { ref: "configPathContainer", className: "inline-block", href: "", on: {
                    click: evt => {
                        evt.preventDefault();
                        this.openConfigPath();
                    },
        ...
        if (this.props.buildStatus) {
            ...
            statusContainer = (etch.dom("div", { ref: "statusContainer", className: "inline-block" },
                etch.dom("span", { ref: "statusText", class: cls }, text)));
        }
        let progress = null;
        if (this.props.progress) {
            progress = (etch.dom("progress", { ref: "progress", style: { verticalAlign: "baseline" }, className: "inline-block", max: this.props.progress.max, value: this.props.progress.value }));
        }
