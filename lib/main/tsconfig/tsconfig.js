...
function getProjectSync(pathOrSrcFile) {
    ...
    try {
        ...
        throw errorWithDetails(new Error(exports.errors.GET_PROJECT_JSON_PARSE_FAILED), { projectFilePath: projectFile, error: ex.message });
    }
    ...
    if (projectSpec.filesGlob) {
        try {
            ...
            throw errorWithDetails(new Error(exports.errors.GET_PROJECT_GLOB_EXPAND_FAILED), { glob: projectSpec.filesGlob, projectFilePath: projectFile, error: ex.message });
        }
