...
var LanguageServiceHost = (function () {
    function LanguageServiceHost(config) {
        ...
        this.getDefaultLibFilename = function () {
            return _this.config.project.compilerOptions.target === ts.ScriptTarget.ES6 ? "lib.es6.d.ts" : "lib.d.ts";
        };
        this.log = function () { return void 0; };
        this.error = function () { return void 0; };
        this.trace = function () { return void 0; };
        config.project.files.forEach(function (file) { return _this.addScript(file, fs.readFileSync(file).toString()); });
    }
