...
var WorkerBridge = (function () {
    function WorkerBridge(target) {
        ...
        this.messageHandler = function (message) {
            ...
            switch (data.operation) {
                case 3 /* EXPOSE */:
                    _this.proxy = createProxy(data.descriptor, function (args) { return _this.target.postMessage(args); }, _this.resolverMap);
    ...
    WorkerBridge.prototype.dispose = function () {
        this.signals.forEach(function (signalDesc) { return signalDesc.signal.remove(signalDesc.handler); });
